<div class="contents_button_container">
	<div class="small_header_top3">
    	...
    	<div class="small_header_title">Patient Details > Edit Visit</div>
  	</div>
</div>
            ...
            <form name="frmPatientInfo" id="frmPatientInfo" method="post" action="<?php echo site_url('patient'); ?>">
            	...
            	<div class="show_hide_container3">                
                    <table class="inside_table_container">
                        ...
                        <tr>
                            <td>Weight</td>
                            <td>: <input name="weight" type="text" class="searchbox_style8" id="weight" value="<?php echo $details[0]->weight; ?>" /></td>
                        </tr>                    
                    </table>                
          		</div>
                <div style="clear:both; height:10px;"></div>
                ...
                <div class="show_hide_container3">
                    ...
                    <div id="addinput">
                    <?php
					foreach($patient_medicine as $val) {
					?>
						<table class="inside_table_container">
                        	<tr>
                            	<td width="100">Generic name</td>
                                <td>: <input readonly="readonly" type="text" class="searchbox_style8" name="generic_name[]" value="<?php echo $val->generic_name; ?>" /></td>
                                <td width="100">Brand name</td>
                                <td width="230">: <input readonly="readonly" type="text" class="searchbox_style8" name="brand_name[]" value="<?php echo $val->brand_name; ?>" /></td>
                       		</tr>
                            <tr>
                            	<td>Preparation</td>
                                <td>: <input type="text" class="searchbox_style8" name="preparation[]" value="<?php echo $val->preparation; ?>" /></td>
                                <td>Sig</td>
                                <td>: <input type="text" class="searchbox_style8" name="dosage[]" value="<?php echo $val->dosage; ?>" /></td>
                         	</tr>
                            <tr>
                            	<td>#</td>
                                <td colspan="3">: <input type="text" class="searchbox_style8" name="pcs[]" value="<?php echo $val->pcs; ?>" /></td>
                          	</tr>
                            <tr>
                            	<td colspan="4"><a class="link_show_hide" href="#" id="remNew">- Remove Medicine</a><div class="show_hide_container7"><input type="hidden" name="medicine_id[]" value="<?php echo $val->medicine_id; ?>" /></div></td>
                         	</tr>
                        </table>
                   	<?php
					}
                ...
                <div class="show_hide_container3">                	
                    <input type="hidden" name="submitForm" value="update_visit" />
                    <input type="hidden" name="age" value="<?php echo $info[0]->age; ?>" />
                    <input type="hidden" name="patient_id" value="<?php echo $info[0]->id; ?>" />
                    <input type="hidden" name="visit_id" value="<?php echo $details[0]->id; ?>" />
