<div class="contents_button_container">
	<div class="small_header_top3">
    	...
    	<div class="small_header_title">Patient Details > Delete Visit</div>
  	</div>
</div>
            ...
            <form name="frmPatientInfo" id="frmPatientInfo" method="post" action="<?php echo site_url('patient'); ?>">
            	...
            	<div class="show_hide_container3">                
                    <table class="inside_table_container">
                        ...
                        <tr>
                            <td>Weight</td>
                            <td>: <?php echo $details[0]->weight; ?></td>
                        </tr>                    
                    </table>                
          		</div>
                <div style="clear:both; height:10px;"></div>
					...
					?>
						<table class="inside_table_container">
                        	<tr>
                                ...
                                <td width="230">: <?php echo $val->brand_name; ?></td>
                       		</tr>
                            <tr>
                            	<td>Preparation</td>
                                <td>: <?php echo $val->preparation; ?></td>
                                <td>Sig</td>
                                <td>: <?php echo $val->dosage; ?></td>
                         	</tr>
                            <tr>
                            	<td>#</td>
                                <td colspan="3">: <?php echo $val->pcs; ?></td>
                          	</tr>
                        </table>
                   	<?php
					}
                ...
                <div class="show_hide_container3">                	
                    <input type="hidden" name="submitForm" value="delete_visit" />
                    ...
                    <a href="#" id="btnSavePatientInfo"><img src="<?php echo theme_img('button_delete.jpg'); ?>" border="0" /></a>
